...
<body>
    ...
    echo'
    <div class="container" style="color:#2ECC71;text-align:center;">
    <h3 class="text-center" style="margin-top: 50px; margin-bottom: 50px; color: green;">Recently Added Products</h3>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner d-flex justify-content-around" style="background:#2E4053;">';
        ...
        while($caraouselRow = mysqli_fetch_assoc($caraouselResult)){
            ...
            <div class="carousel-item active" style="padding: 20px; margin-bottom: 10px">
             ...
             <a href="/store/productPage.php?productId='.$carouselId.'">
                    <img class="rounded" src="/store/uploads/'.$caraouselImg.'" alt="" style="height: 700px; width: 398px;display: block;margin-left: auto;margin-right: auto">
    ...
    <div class="row" style="padding-top: 90px; margin-bottom: 50px">
        <h3 class="text-center" style="margin-bottom:  50px; margin-bottom: 50px; color: green;">All Products</h3>
        ...
        echo'
           <div class="col-md-3 mt-2">
                <div class="card" style="height: 600px">
                                    <div class="card-body">
                                        <div class="card">
                                                <a href="/store/productPage.php?productId='.$id.'"><img src="/store/uploads/'.$img.'" class="" style="height: 320px; width: 200px"></a>
                                        </div>
                                    </div>
